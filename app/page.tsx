...
export default function Home() {
  ...
  return (
    /* OUTER WRAPPER */
    <div className="min-h-screen text-slate-900 font-sans antialiased relative selection:bg-slate-900 selection:text-white bg-[#E2E8F0] overflow-x-hidden w-full flex justify-center">
      ...
      {/* 1. MAIN CONTAINER: Lebar 1440px, Min-Height 2355px, Padding(Margin) Y: 130px, X: 100px */}
      <div className="relative z-10 w-[1440px] min-h-[2355px] px-[100px] py-[130px] flex flex-col items-center shrink-0 box-border">
        
        {/* VIEW 1: BERANDA UTAMA */}
        {currentView === 'main' && (
          <div className="flex flex-col w-[1239px]">
            
            {/* 2. SECTION: HEADER - Ukuran: 1239x430, Rounded 28 */}
            <section
              id="home"
              className="relative overflow-hidden flex flex-col px-[50px] py-[40px] text-slate-900 liquid-glass-3d w-[1239px] h-[430px] rounded-[28px] shrink-0 box-border"
            >
              <div className="flex flex-row items-start justify-between relative z-20 h-full">
                
                {/* Area Teks & Kontak Kiri */}
                <div className="flex flex-col justify-start text-left w-[65%] shrink-0 pt-[20px]">
                  ...
                  {/* Card Kontak - Email Update & Hanya Icon Disini */}
                  <div className="grid grid-cols-2 gap-[12px] w-[540px]">
                    <a href="mailto:andhikarievaldy07@gmail.com" className="h-[44px] rounded-full text-[12px] font-bold text-slate-800 bg-white/80 hover:bg-white border border-white shadow-sm transition-all flex items-center px-4 gap-2.5 whitespace-nowrap truncate">
                      ...
                      <span className="truncate">andhikarievaldy07@gmail.com</span>
                    </a>
                ...
                {/* Foto Profil Kanan - Ukuran: 318x380 */}
                {!profileImgError && (
                  <div className="absolute right-[40px] bottom-0 w-[318px] h-[380px] flex justify-end items-end pointer-events-none z-10">
                    <img
                      src="/profile.png"
              ...
              {/* Menu Navigation - Absolute Center Bottom */}
              <nav className="absolute bottom-[24px] left-1/2 -translate-x-1/2 z-30 flex items-center gap-2 p-1.5 rounded-full bg-white/60 border border-white shadow-sm backdrop-blur-md">
            ...
            {/* 3. SECTION: ABOUT ME - Jarak: mt-[20px], Ukuran: 1239x205, border-none */}
            <section id="about" className="mt-[20px] px-[40px] text-slate-900 liquid-glass-3d w-[1239px] h-[205px] rounded-[28px] overflow-hidden flex flex-row items-center justify-between gap-[60px] shrink-0 border-none box-border">
              ...
              {/* Card Sertifikat - HANYA 2 Sertifikat */}
              <div className="w-[360px] shrink-0 flex flex-col justify-center h-full">
                ...
                <div className="flex flex-col gap-[12px]">
                  <button
                    ...
                    className="w-full h-[46px] rounded-[14px] px-5 flex items-center justify-between text-[12px] font-bold text-slate-900 bg-white/80 hover:bg-white border border-white shadow-sm transition-all cursor-pointer group"
                  >
            ...
            <section id="services" className="mt-[60px] w-[1239px] flex flex-col shrink-0 box-border">
              ...
              {/* Item Card - 4 buah (295x257), Jarak Horizontal (Gap): 20px, Tanpa Ikon */}
              <div className="flex flex-row justify-between w-full">
                {[
                  ...
                  <div
                    key={idx}
                    className="w-[295px] h-[257px] p-[30px] transition-all duration-300 flex flex-col justify-center liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0 box-border"
                  >
                    {/* Judul: 1 Baris, No Wrap */}
                    <h3 className="text-[17px] font-bold text-slate-900 leading-snug whitespace-nowrap overflow-hidden text-ellipsis mb-4">
                      {item.title}
                    </h3>
                    <p className="text-[13px] font-normal text-slate-600 leading-relaxed text-justify line-clamp-5">
                      {item.desc}
                    </p>
                  </div>
                ))}
            ...
            {/* 5. SECTION: FEATURED PROJECTS - Jarak: mt-[20px] */}
            <section id="work" className="mt-[20px] w-[1239px] flex flex-col shrink-0 box-border">
              ...
              {/* Item Projects - 4 buah (295x257), Jarak Horizontal (Gap): 20px, Tanpa Ikon */}
              <div className="flex flex-row justify-between w-full">
                {[
                  {
                  ...
                  <div
                    key={idx}
                    className="w-[295px] h-[257px] p-[26px] transition-all duration-300 flex flex-col justify-center liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0 box-border"
                  >
                    <div className="flex-1 flex flex-col justify-center">
                      {/* Judul: 1 Baris, No Wrap */}
                      <h3 className="text-[16px] font-extrabold text-slate-900 leading-snug whitespace-nowrap overflow-hidden text-ellipsis mb-3">
                        {proj.name}
                      </h3>
                    ...
                    <button
                      type="button"
                      onClick={proj.action}
                      className="w-full inline-flex items-center justify-center h-[42px] rounded-[14px] text-[12px] font-bold text-white bg-slate-900 hover:bg-slate-800 transition-all cursor-pointer shadow-sm mt-3"
                    >
            ...
            <section id="tools" className="mt-[60px] w-[1239px] flex flex-col shrink-0 box-border">
              ...
              {/* Grid Layout Tools - Item 9 buah (398x128), Horizontal/Vertical Gap: 20px, Tanpa Ikon */}
              <div className="flex flex-wrap gap-[20px] w-[1239px]">
                {[
                  ...
                  <div
                    key={idx}
                    className="w-[398px] h-[128px] p-[20px] transition-all duration-300 flex flex-col justify-center liquid-glass-3d rounded-[18px] hover:scale-[1.015] overflow-hidden shrink-0 box-border"
                  >
            ...
            {/* 7. SECTION: FOOTER - Jarak: mt-[20px], Ukuran: 1239x115 */}
            <footer
              id="contact"
              className="mt-[20px] px-10 w-[1239px] h-[115px] text-slate-900 liquid-glass-3d rounded-[18px] overflow-hidden flex flex-row items-center justify-between shrink-0 box-border"
            >
              <div className="space-y-1 text-left flex flex-col justify-center h-full">
                <span className="text-[11px] font-extrabold text-slate-700 tracking-wider uppercase block">Let&apos;s Connect</span>
                <h2 className="text-[22px] font-black text-slate-900 uppercase whitespace-nowrap overflow-hidden text-ellipsis">INTERESTED IN WORKING TOGETHER?</h2>
              </div>

              <div className="flex gap-4 shrink-0">
                <a
                  href="mailto:andhikarievaldy07@gmail.com"
                  className="text-white font-bold text-[13px] px-8 py-3.5 rounded-full shadow-md bg-slate-900 hover:bg-slate-800 transition-all flex items-center"
                >
                  Send Email Direct
                </a>
                <a
                  ...
                  className="text-slate-900 font-bold text-[13px] px-8 py-3.5 rounded-full bg-white/80 border border-white hover:bg-white transition-all shadow-sm flex items-center"
                >
                  LinkedIn Profile
                </a>
              </div>
        ...
        {/* ========================================================= */}
        {/* VIEW LAINNYA DIADAPTASI MENJADI UKURAN 1239PX             */}
        {/* ========================================================= */}
          ...
          <div className="w-[1239px] flex flex-col gap-[20px] shrink-0 box-border">
            <div className="p-10 text-slate-900 space-y-4 liquid-glass-3d rounded-[28px] overflow-hidden w-full h-[245px] flex flex-col justify-center box-border">
              ...
              <div className="space-y-1">
                <h1 className="text-[34px] font-black text-slate-900 leading-tight whitespace-nowrap overflow-hidden text-ellipsis">Social Media Management</h1>
            ...
            <div className="flex flex-row flex-wrap justify-between w-full">
              {[
                ...
                <div key={idx} className="w-[609.5px] min-h-[229px] p-8 transition-all duration-300 flex flex-col justify-between liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0 box-border">
                  <div className="space-y-2 mb-4">
                    <h2 className="text-[20px] font-extrabold text-slate-900 leading-tight whitespace-nowrap overflow-hidden text-ellipsis">{item.name}</h2>
        ...
        {currentView === 'photography' && (
          <div className="w-[1239px] flex flex-col gap-[20px] shrink-0 box-border">
            <div className="p-10 text-slate-900 space-y-4 liquid-glass-3d rounded-[28px] overflow-hidden w-full h-[245px] flex flex-col justify-center box-border">
              ...
              <div className="space-y-1">
                <h1 className="text-[34px] font-black text-slate-900 leading-tight whitespace-nowrap overflow-hidden text-ellipsis">Commercial Photography</h1>
                <p className="text-[14px] font-normal text-slate-700 leading-relaxed text-justify max-w-[800px]">
            ...
            <div className="flex flex-row flex-wrap gap-[20px] w-full">
              {[
                { name: 'Product Photography – Glovecare', desc: 'Pengambilan foto komersial produk perawatan kendaraan Glovecare dengan pengarahan estetika visual, penataan lighting studio, serta retouching dan color grading mendetail menggunakan Adobe Lightroom.', action: () => openPreview({ title: 'Product Photography – Glovecare', mediaList: ['/portofolio/produk-1.jpg', '/portofolio/produk-3.jpg', '/portofolio/produk-4.jpg'] }) }
              ].map((item, idx) => (
                <div key={idx} className="w-[400px] min-h-[229px] p-8 transition-all duration-300 flex flex-col justify-between liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0 box-border">
                  <div className="space-y-2 mb-4">
                    <h2 className="text-[18px] font-extrabold text-slate-900 leading-tight whitespace-nowrap overflow-hidden text-ellipsis">{item.name}</h2>
        ...
        {currentView === 'videography' && (
          <div className="w-[1239px] flex flex-col gap-[20px] shrink-0 box-border">
            <div className="p-10 text-slate-900 space-y-4 liquid-glass-3d rounded-[28px] overflow-hidden w-full h-[245px] flex flex-col justify-center box-border">
              ...
              <div className="space-y-1">
                <h1 className="text-[34px] font-black text-slate-900 leading-tight whitespace-nowrap overflow-hidden text-ellipsis">Videography &amp; Video Editing</h1>
                <p className="text-[14px] font-normal text-slate-700 leading-relaxed text-justify max-w-[800px]">
            ...
            <div className="flex flex-row flex-wrap gap-[19.5px] w-full">
              {[
        ...
        {currentView === 'graphic-design' && (
          <div className="w-[1239px] flex flex-col gap-[20px] shrink-0 box-border">
            <div className="p-10 text-slate-900 space-y-4 liquid-glass-3d rounded-[28px] overflow-hidden w-full h-[245px] flex flex-col justify-center box-border">
              ...
              <div className="space-y-1">
                <h1 className="text-[34px] font-black text-slate-900 leading-tight whitespace-nowrap overflow-hidden text-ellipsis">Graphic Design &amp; Visual Content</h1>
                <p className="text-[14px] font-normal text-slate-700 leading-relaxed text-justify max-w-[800px]">
            ...
            <div className="flex flex-row flex-wrap gap-[19.5px] w-full">
              {[
                { name: 'Banner Seminar – Esa Unggul', desc: 'Perancangan banner promosi seminar terpadu untuk kebutuhan publikasi visual dan media informasi acara.', action: () => openPreview({ title: 'Banner Seminar – Esa Unggul University', mediaList: ['/portofolio/flyer-esa-unggul-1.jpg', '/portofolio/flyer-esa-unggul-2.jpg', '/portofolio/flyer-esa-unggul-3.jpg', '/portofolio/flyer-esa-unggul-4.jpg', '/portofolio/flyer-esa-unggul-5.jpg', '/portofolio/flyer-esa-unggul-6.jpg', '/portofolio/flyer-esa-unggul-7.jpg'] }) },
                { name: 'Display Marketplace', desc: 'Penataan visual etalase toko digital Glovecare guna menciptakan tampilan produk yang profesional dan menarik minat pembeli.', action: () => openPreview({ title: 'Display Marketplace – Glovecare', mediaList: ['/portofolio/display-glovecare-1.jpg', '/portofolio/display-glovecare-2.jpg', '/portofolio/display-glovecare-3.jpg', '/portofolio/display-glovecare-4.jpg', '/portofolio/display-glovecare-5.jpg'] }) },
                ...
                { name: 'Flyer Seminar', desc: 'Perancangan flyer promosi seminar terpadu untuk kebutuhan publikasi cetak maupun media digital.', action: () => openPreview({ title: 'Flyer Seminar – Esa Unggul University', mediaList: ['/portofolio/flyer-esa-unggul-1.jpg', '/portofolio/flyer-esa-unggul-2.jpg', '/portofolio/flyer-esa-unggul-3.jpg', '/portofolio/flyer-esa-unggul-4.jpg', '/portofolio/flyer-esa-unggul-5.jpg', '/portofolio/flyer-esa-unggul-6.jpg', '/portofolio/flyer-esa-unggul-7.jpg'] }) },
                ...
                { name: 'Logo Design', desc: 'Pengembangan desain logo utama sebagai fondasi identitas visual merek yang kuat dan konsisten.', action: () => openPreview({ title: 'Logo Design', mediaList: ['/portofolio/logo-design-1.jpg', '/portofolio/logo-design-2.jpg', '/portofolio/logo-design-3.jpg', '/portofolio/logo-design-4.jpg', '/portofolio/logo-design-5.jpg', '/portofolio/logo-design-6.jpg', '/portofolio/logo-design-7.jpg'] }) },
