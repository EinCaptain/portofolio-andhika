        ...
        {currentView === 'main' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full max-w-[2355px] mx-auto items-start">
            ...
            <div className="w-full max-w-[785px] mx-auto space-y-6">
              ...
              >
                  ...
                  {!profileImgError && (
                    <div className="sm:col-span-5 flex justify-center sm:justify-end items-end h-full mt-4 sm:mt-0">
                      <img
                        ...
                        className="w-44 sm:w-52 max-w-full h-auto object-contain object-bottom drop-shadow-[0_20px_35px_rgba(15,23,42,0.18)]"
                ...
                <div className="flex justify-center relative z-20 pt-2">
                  <div className="rounded-full p-1 flex items-center gap-1 text-[11px] bg-white/80 backdrop-blur-lg border border-white shadow-sm max-w-full overflow-x-auto scrollbar-none">
                    ...
                    <a href="#about" className="px-2.5 py-1.5 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors whitespace-nowrap">
                      About
                    </a>
                    <a href="#tools" className="px-2.5 py-1.5 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors whitespace-nowrap">
                      Software
                    </a>
                    <a href="#services" className="px-2.5 py-1.5 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors whitespace-nowrap">
                      Services
                    </a>
                    <a href="#work" className="px-2.5 py-1.5 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors whitespace-nowrap">
                      Work
                    </a>
                    <a href="#contact" className="px-2.5 py-1.5 rounded-full text-slate-700 hover:text-slate-950 font-bold transition-colors whitespace-nowrap">
                      Links
                    </a>
                  </div>
                </div>
              ...
              {/* CARD ABOUT ME */}
              <section id="about" className="p-6 text-slate-900 liquid-glass-3d rounded-3xl overflow-hidden w-full">
                <div className="space-y-4 relative z-10">
                  <div>
                    <span className="text-[11px] font-extrabold text-slate-700 tracking-wider uppercase block">
                      About Me
                    </span>
                    <h2 className="text-[18px] sm:text-[20px] font-black text-slate-900 leading-tight mt-0.5">
                  ...
                  <div className="space-y-2.5 pt-1">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3 rounded-2xl text-[12px] font-normal text-slate-900 transition-all bg-white/70 backdrop-blur-md border border-white hover:bg-white/90 shadow-sm group cursor-pointer text-left"
                    >
                      <div className="flex items-center gap-2.5">
                        <div className="w-6 h-6 rounded-xl flex items-center justify-center text-slate-800 bg-white/90 shrink-0 border border-slate-200/80 shadow-sm">
            ...
            <div className="w-full max-w-[785px] mx-auto space-y-6">
              ...
              <section id="tools" className="space-y-4 w-full">
                <div className="p-5 text-slate-900 liquid-glass-3d rounded-3xl">
                  ...
                  <h2 className="text-[18px] sm:text-[22px] font-black text-slate-900 mt-0.5">Tools & Software Proficiency</h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  {[
                    ...
                    <div
                      key={idx}
                      className="p-4 transition-all duration-300 h-full flex flex-col justify-between liquid-glass-3d rounded-3xl hover:scale-[1.015] overflow-hidden"
                    >
                      <div className="space-y-2 relative z-10">
                        <div className="flex items-start justify-between gap-2">
                          <h3 className="text-[13.5px] sm:text-[14px] font-bold text-slate-900 leading-snug text-left">
                            {tool.name}
                          </h3>
            ...
            <div className="w-full max-w-[785px] mx-auto space-y-6">
              ...
              <section id="services" className="space-y-4 w-full">
                <div className="p-5 text-slate-900 liquid-glass-3d rounded-3xl">
                  ...
                  <h2 className="text-[18px] sm:text-[22px] font-black text-slate-900 mt-0.5">Services & Expertise</h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  {[
                    {
                      icon: (
                        <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div
                      key={idx}
                      className="p-4 transition-all duration-300 space-y-2 h-full flex flex-col justify-between liquid-glass-3d rounded-3xl hover:scale-[1.015] overflow-hidden"
                    >
                      <div className="space-y-1.5 relative z-10">
                        <div className="w-7 h-7 rounded-2xl text-slate-800 bg-white/80 border border-white flex items-center justify-center shrink-0 shadow-sm">
                          {item.icon}
                        </div>
                        <h3 className="text-[13px] font-bold text-slate-900 leading-snug text-left">
                          {item.title}
                        </h3>
                        <p className="text-[10.5px] font-normal text-slate-600 leading-relaxed text-left">
                          {item.desc}
                        </p>
                      </div>
                    </div>
              ...
              <section id="work" className="space-y-4 w-full">
                <div className="p-5 text-slate-900 liquid-glass-3d rounded-3xl">
                  ...
                  <h2 className="text-[18px] sm:text-[22px] font-black text-slate-900 mt-0.5">Featured Projects</h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 w-full">
                  {[
                    ...
                    <div
                      key={idx}
                      className="p-4 transition-all duration-300 space-y-2.5 flex flex-col justify-between liquid-glass-3d rounded-3xl hover:scale-[1.015] overflow-hidden w-full"
                    >
                      ...
                      <div className="pt-1 relative z-10">
                        <button
                          type="button"
                          onClick={proj.action}
                          className="w-full inline-flex items-center justify-center px-3.5 py-1.5 rounded-2xl text-[11px] font-bold text-white bg-slate-900/90 hover:bg-slate-900 transition-all cursor-pointer shadow-sm backdrop-blur-sm"
                        >
              ...
              >
                <div className="relative z-10 space-y-3">
                  ...
                  <h2 className="text-[18px] sm:text-[22px] font-black text-slate-900">Interested in Working Together?</h2>
                  <div className="flex flex-wrap justify-center gap-2.5 pt-1">
                    <a
                      href="mailto:andhikarievaldy@gmail.com"
                      className="text-white font-bold text-[11.5px] px-5 py-2.5 rounded-full shadow-md bg-slate-900/90 hover:bg-slate-900 transition-all backdrop-blur-sm"
                    >
                      Send Email Direct
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-slate-900 font-bold text-[11.5px] px-5 py-2.5 rounded-full bg-white/80 backdrop-blur-md border border-white hover:bg-white transition-all shadow-sm"
                    >
                      LinkedIn Profile
                    </a>
                  </div>
          ...
          <div className="space-y-6 md:space-y-8 w-full mx-auto max-w-[1500px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
              {[
                ...
                >
                  <div className="space-y-1 relative z-10">
                    <h2 className="text-[14px] sm:text-[15px] font-extrabold text-slate-900 leading-tight tracking-tight">{item.name}</h2>
