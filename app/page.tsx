...
export default function Home() {
  ...
  return (
    /* OUTER WRAPPER: Background dan Setup */
    <div className="min-h-screen text-slate-900 font-sans antialiased relative selection:bg-slate-900 selection:text-white bg-[#E2E8F0] w-full flex justify-center">
      ...
      {/* MAIN CONTAINER: Lebar maks 1440px, tinggi min 1920px, Padding Atas Bawah 50px, Kiri Kanan 95px */}
      <div className="relative z-10 w-[1440px] max-w-[1440px] min-h-[1920px] px-[95px] py-[50px] flex flex-col shrink-0 overflow-x-hidden box-border mx-auto">
        
        {/* VIEW 1: BERANDA UTAMA */}
        {currentView === 'main' && (
          <div className="flex flex-col items-center">
            
            {/* 1. HEADER CARD - 1250x370px, Rounded 28px */}
            <section
              id="home"
              className="relative overflow-hidden flex flex-col px-12 py-10 text-slate-900 liquid-glass-3d w-[1250px] h-[370px] rounded-[28px] shrink-0 box-border"
            >
              <div className="flex flex-col h-full relative z-20">
                {/* Teks Identitas */}
                <div className="flex flex-col justify-start text-left w-[65%] shrink-0">
                  <div className="text-slate-800 font-black text-[12px] tracking-wider uppercase mb-2">
                    MARKETING COMMUNICATION SPECIALIST
                  </div>

                  <h1 className="text-[48px] font-black text-slate-900 tracking-tight leading-none uppercase whitespace-nowrap truncate mb-6">
                    ANDHIKA RIEVALDY
                  </h1>

                  {/* Card Kontak - Disesuaikan rapi */}
                  <div className="grid grid-cols-2 gap-4 max-w-[680px]">
                    <a href="mailto:andhikarievaldy@gmail.com" className="h-[46px] rounded-full text-[12px] font-bold text-slate-800 bg-white/80 hover:bg-white border border-white shadow-sm transition-all flex items-center px-5 gap-3 whitespace-nowrap truncate">
                    ...
                    <a href="https://www.linkedin.com/in/rievaldyandhika/" target="_blank" rel="noopener noreferrer" className="h-[46px] rounded-full text-[12px] font-bold text-slate-800 bg-white/80 hover:bg-white border border-white shadow-sm transition-all flex items-center px-5 gap-3 whitespace-nowrap truncate">
                    ...
                    <a href="https://wa.me/6285179770217" target="_blank" rel="noopener noreferrer" className="h-[46px] rounded-full text-[12px] font-bold text-slate-800 bg-white/80 hover:bg-white border border-white shadow-sm transition-all flex items-center px-5 gap-3 whitespace-nowrap truncate">
                    ...
                    <div className="h-[46px] rounded-full text-[12px] font-bold text-slate-800 bg-white/80 border border-white shadow-sm flex items-center px-5 gap-3 cursor-default whitespace-nowrap truncate">
                ...
                {/* Navigasi Menu - Tengah bawah secara rapi */}
                <nav className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-1.5 p-2 rounded-full bg-white/60 border border-white shadow-sm z-30">
                  <a href="#home" className="px-6 py-2 rounded-full bg-slate-900 text-white text-[12px] font-bold shadow-sm transition-all whitespace-nowrap">Home</a>
                  <a href="#about" className="px-5 py-2 rounded-full text-slate-700 hover:bg-white text-[12px] font-bold transition-all whitespace-nowrap">About</a>
                  <a href="#services" className="px-5 py-2 rounded-full text-slate-700 hover:bg-white text-[12px] font-bold transition-all whitespace-nowrap">Services</a>
                  <a href="#work" className="px-5 py-2 rounded-full text-slate-700 hover:bg-white text-[12px] font-bold transition-all whitespace-nowrap">Work</a>
                  <a href="#tools" className="px-5 py-2 rounded-full text-slate-700 hover:bg-white text-[12px] font-bold transition-all whitespace-nowrap">Software</a>
                  <a href="#contact" className="px-5 py-2 rounded-full text-slate-700 hover:bg-white text-[12px] font-bold transition-all whitespace-nowrap">Links</a>
                </nav>
              </div>

              {/* Foto Profil - 320x370px di kanan proporsional */}
              {!profileImgError && (
                <div className="absolute right-6 bottom-0 w-[320px] h-[370px] flex justify-center items-end pointer-events-none z-10">
                  <img
                    src="/profile.png"
            ...
            {/* 2. ABOUT ME CARD - mt-[30px], 1250x150px, Rounded 28px */}
            <section id="about" className="mt-[30px] px-[40px] text-slate-900 liquid-glass-3d w-[1250px] h-[150px] rounded-[28px] overflow-hidden flex flex-row items-center justify-between gap-[50px] shrink-0 box-border">
              {/* Kolom Teks About Me */}
              <div className="flex-1 h-full flex flex-col justify-center">
                <span className="text-[11px] font-black text-slate-800 tracking-wider uppercase block mb-1">
                  ABOUT ME
                </span>
                
                <h2 className="text-[24px] font-black text-slate-900 leading-none whitespace-nowrap truncate mb-[8px]">
                  Rievaldy Andhika Koswara, S.I.Kom
                </h2>

                <p className="text-[12.5px] font-medium text-slate-700 leading-relaxed text-justify line-clamp-3">
              ...
              {/* Kolom Sertifikat (HANYA 2) */}
              <div className="w-[360px] shrink-0 flex flex-col justify-center border-l border-slate-900/10 pl-[40px] h-full py-4">
                <span className="text-[10px] font-extrabold text-slate-700 tracking-wider uppercase block mb-2.5">
                ...
                <div className="flex flex-col gap-[12px]">
                  <button
                    ...
                    className="w-full h-[36px] rounded-[12px] px-4 flex items-center justify-between text-[11px] font-bold text-slate-900 bg-white/70 hover:bg-white border border-white shadow-sm transition-all cursor-pointer group"
                  >
            ...
            {/* 3. SERVICES & EXPERTISE SECTION - Jarak 40px */}
            <section id="services" className="mt-[40px] w-[1250px] flex flex-col shrink-0 box-border">
              
              {/* Card Judul - 1250x58px, Rounded 18px */}
              <div className="w-[1250px] h-[58px] px-8 text-slate-900 liquid-glass-3d rounded-[18px] flex flex-col justify-center mb-[20px] shrink-0">
                ...
                <h2 className="text-[18px] font-black text-slate-900 uppercase leading-tight whitespace-nowrap truncate">SERVICES &amp; EXPERTISE</h2>
              </div>

              {/* Grid Layout Cards - Gap presisi 29px */}
              <div className="flex flex-row gap-[29px] w-[1250px] justify-between">
                {[
                  {
                    ...
                    icon: <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
                  },
                  {
                    ...
                    icon: <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="M2 2l7.586 7.586"/><circle cx="11" cy="11" r="2"/></svg>
                  },
                  {
                    ...
                    icon: <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="8" width="18" height="12" rx="2" ry="2"/><path d="M16 8v-2a2 2 0 00-2-2H10a2 2 0 00-2 2v2"/><circle cx="12" cy="14" r="3"/></svg>
                  },
                  {
                    ...
                    icon: <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>
                  }
                ].map((item, idx) => (
                  /* Card Item - 291x213px, Rounded 28px */
                  <div
                    key={idx}
                    className="w-[291px] h-[213px] p-6 flex flex-col justify-start liquid-glass-3d rounded-[28px] overflow-hidden shrink-0"
                  >
                    <div className="w-10 h-10 mb-3.5 rounded-full text-slate-800 bg-white/80 border border-white flex items-center justify-center shrink-0 shadow-sm">
                      {item.icon}
                    </div>
                    {/* Judul: 1 Baris (Truncate) */}
                    <h3 className="text-[14px] font-bold text-slate-900 leading-snug whitespace-nowrap truncate mb-2.5">
                      {item.title}
                    </h3>
                    <p className="text-[11.5px] font-normal text-slate-600 leading-relaxed text-justify line-clamp-4">
                      {item.desc}
                    </p>
                  </div>
                ))}
            ...
            {/* 4. FEATURED PROJECTS SECTION - Jarak 20px */}
            <section id="work" className="mt-[20px] w-[1250px] flex flex-col shrink-0 box-border">
              ...
              <div className="w-[1250px] h-[58px] px-8 text-slate-900 liquid-glass-3d rounded-[18px] flex flex-col justify-center mb-[20px] shrink-0">
                ...
                <h2 className="text-[18px] font-black text-slate-900 uppercase leading-tight whitespace-nowrap truncate">FEATURED PROJECTS</h2>
              </div>
              ...
              <div className="flex flex-row gap-[29px] w-[1250px] justify-between">
                {[
                  ...
                  },
                  {
                   ...
                   /* Card Item Project - 291x213px, Rounded 28px */
                  <div
                    key={idx}
                    className="w-[291px] h-[213px] p-6 flex flex-col justify-between liquid-glass-3d rounded-[28px] overflow-hidden shrink-0"
                  >
                    <div>
                      <div className="w-10 h-10 mb-3 rounded-full text-slate-800 bg-white/80 border border-white flex items-center justify-center shrink-0 shadow-sm">
                        {proj.icon}
                      </div>
                      <h3 className="text-[14px] font-extrabold text-slate-900 leading-snug whitespace-nowrap truncate mb-2">
                        {proj.name}
                      </h3>
                      <p className="text-[11.5px] font-normal text-slate-600 leading-relaxed text-justify line-clamp-3">
                        {proj.desc}
                      </p>
                    </div>
                    ...
                    <button
                      type="button"
                      onClick={proj.action}
                      className="w-full inline-flex items-center justify-center h-[36px] rounded-[14px] text-[12px] font-bold text-white bg-slate-900 hover:bg-slate-800 transition-all cursor-pointer shadow-sm"
                    >
            ...
            {/* 5. TOOLS & SOFTWARE PROFICIENCY SECTION - Jarak 40px */}
            <section id="tools" className="mt-[40px] w-[1250px] flex flex-col shrink-0 box-border">
              ...
              <div className="w-[1250px] h-[58px] px-8 text-slate-900 liquid-glass-3d rounded-[18px] flex flex-col justify-center mb-[20px] shrink-0">
                ...
                <h2 className="text-[18px] font-black text-slate-900 uppercase leading-tight whitespace-nowrap truncate">TOOLS &amp; SOFTWARE PROFICIENCY</h2>
              </div>

              {/* Grid Layout Tools - Gap presisi 20px (Horizontal & Vertikal) */}
              <div className="grid grid-cols-3 gap-[20px] w-[1250px]">
                {[
                  {
                  ...
                  /* Card Item Tools - 403x114px, Rounded 18px */
                  <div
                    key={idx}
                    className="w-[403px] h-[114px] px-6 py-4 flex flex-col justify-center liquid-glass-3d rounded-[18px] overflow-hidden shrink-0 box-border"
                  >
                    ...
                    <p className="text-[11px] font-normal text-slate-600 leading-relaxed text-justify line-clamp-2">
                      {tool.desc}
                    </p>
                  </div>
                ))}
            ...
            {/* 6. FOOTER CARD - Jarak 40px */}
            <footer
              id="contact"
              className="mt-[40px] px-10 h-[79px] w-[1250px] text-slate-900 liquid-glass-3d rounded-[18px] overflow-hidden flex flex-row items-center justify-between shrink-0 box-border"
            >
              ...
              <div className="flex gap-4 shrink-0">
                <a
                  ...
                  className="text-white font-bold text-[12px] px-8 py-2.5 rounded-full shadow-md bg-slate-900 hover:bg-slate-800 transition-all flex items-center"
                >
                  Send Email Direct
                </a>
                <a
                  ...
                  className="text-slate-900 font-bold text-[12px] px-8 py-2.5 rounded-full bg-white/80 border border-white hover:bg-white transition-all shadow-sm flex items-center"
                >
                  LinkedIn Profile
                </a>
              </div>
        ...
        {/* ========================================================= */}
        {/* VIEW HALAMAN DETAIL (Di-fix pada 1250px container)        */}
        {/* ========================================================= */}
        
        {/* VIEW 2: SOCIAL MEDIA MANAGEMENT */}
        {currentView === 'social-media' && (
          <div className="w-[1250px] flex flex-col gap-[20px] shrink-0 box-border mx-auto">
            ...
            <div className="flex flex-row flex-wrap gap-[29px] w-[1250px]">
              {[
                {
                ...
                <div
                  key={idx}
                  className="w-[610px] min-h-[229px] p-8 flex flex-col justify-between liquid-glass-3d rounded-[28px] overflow-hidden shrink-0"
                >
          ...
          <div className="w-[1250px] flex flex-col gap-[20px] shrink-0 box-border mx-auto">
            ...
            <div className="flex flex-row flex-wrap gap-[29px] w-[1250px]">
              {[
                ...
                <div
                  key={idx}
                  className="w-[410px] min-h-[229px] p-8 flex flex-col justify-between liquid-glass-3d rounded-[28px] overflow-hidden shrink-0"
                >
                  <div className="space-y-2 mb-4">
                    <h2 className="text-[18px] font-extrabold text-slate-900 leading-tight whitespace-nowrap truncate">{item.name}</h2>
                    <p className="text-[13px] font-normal text-slate-600 leading-relaxed text-justify">
                      {item.desc}
                    </p>
                  </div>
                  <button
        ...
        {currentView === 'graphic-design' && (
          <div className="w-[1250px] flex flex-col gap-[20px] shrink-0 box-border mx-auto">
            ...
            <div className="flex flex-row flex-wrap gap-[29px] w-[1250px]">
              {[
                {
                  name: 'Banner Seminar – Esa Unggul',
                ...
                {
                  name: 'E-Invitation - Digisite Tech',
                ...
                {
                  name: 'Filter AR – Meta Spark Studio',
      ...
      {/* ======================= MODALS (Fungsionalitas Tidak Diubah) ======================= */}
      {/* MODAL SERTIFIKAT */}
      {activeCert && (
        <div
