...
export default function Home() {
  ...
  return (
    /* OUTER WRAPPER: Fixed Canvas Width to match 1440px Design */
    <div className="min-h-screen text-slate-900 font-sans antialiased relative selection:bg-slate-900 selection:text-white bg-[#E2E8F0] overflow-x-auto w-full flex justify-center">
      {/* AMBIENT LIGHTING BACKGROUND - Dipertahankan */}
      <div
      ...
      {/* MAIN CONTAINER: 1440px Canvas dengan Padding Spesifik (T/B: 50, L/R: 75) */}
      <div className="relative z-10 w-[1440px] px-[75px] py-[50px] flex flex-col shrink-0">
        
        {/* VIEW 1: BERANDA UTAMA */}
        {currentView === 'main' && (
          <div className="flex flex-col">
            
            {/* HERO CARD - Ukuran: 1290x380, Rounded 28 */}
            <section
              id="home"
              className="relative overflow-hidden flex flex-col justify-center px-12 text-slate-900 liquid-glass-3d w-[1290px] h-[380px] rounded-[28px] mb-[20px]"
            >
              <div className="flex flex-row items-center justify-between relative z-20 h-full">
                
                <div className="flex flex-col justify-center text-left w-[60%] shrink-0">
                  <div className="text-slate-800 font-black text-[13px] tracking-wider uppercase mb-2">
                    MARKETING COMMUNICATION SPECIALIST
                  </div>

                  {/* Judul Hero: One Line Force */}
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <a
                      ...
                      className="px-5 py-2.5 rounded-full text-[12px] font-bold text-slate-800 bg-white/80 hover:bg-white border border-white shadow-sm transition-all"
                    >
            ...
            {/* ABOUT ME CARD - Ukuran: 1290x245, Rounded 28 */}
            <section id="about" className="p-[35px] text-slate-900 liquid-glass-3d w-[1290px] h-[245px] rounded-[28px] overflow-hidden flex flex-row items-center gap-[60px] mb-[20px] shrink-0">
              ...
              <div className="flex-1 h-full flex flex-col justify-center">
                ...
                {/* Judul About Me: Jarak 5px ke deskripsi di bawahnya */}
                <h2 className="text-[32px] font-black text-slate-900 leading-none whitespace-nowrap overflow-hidden text-ellipsis mb-[5px]">
              ...
              <div className="w-[372px] shrink-0 flex flex-col justify-center">
                ...
                <div className="flex flex-col gap-[10px]">
                  {/* Card Sertifikat - Ukuran: 372x52, Rounded 14 */}
                  <button
                    type="button"
                    onClick={() => openCert('Sertifikat LSP BNSP', '/certificates/sertifikat-bnsp.pdf', 'pdf')}
                    className="w-[372px] h-[52px] rounded-[14px] px-5 flex items-center justify-between text-[13px] font-bold text-slate-900 bg-white/70 hover:bg-white border border-white shadow-sm transition-all cursor-pointer group"
                  >
                    <span>Sertifikat LSP BNSP</span>
                  ...
                  <button
                    ...
                    className="w-[372px] h-[52px] rounded-[14px] px-5 flex items-center justify-between text-[13px] font-bold text-slate-900 bg-white/70 hover:bg-white border border-white shadow-sm transition-all cursor-pointer group"
                  >
                    <span>Sertifikat Digital Marketing RevoU</span>
                    <span className="text-slate-500 group-hover:text-slate-900 transition-colors">&rarr;</span>
                  </button>
                  <button
                    type="button"
                    ...
                    className="w-[372px] h-[52px] rounded-[14px] px-5 flex items-center justify-between text-[13px] font-bold text-slate-900 bg-white/70 hover:bg-white border border-white shadow-sm transition-all cursor-pointer group"
                  >
                    <span>Sertifikat Workshop Copywriter</span>
                    <span className="text-slate-500 group-hover:text-slate-900 transition-colors">&rarr;</span>
                  </button>
                </div>
              </div>
            ...
            <section id="services" className="w-[1290px] flex flex-col shrink-0 mb-[20px]">
              
              {/* Card Judul - Ukuran: 1290x64, Rounded 18, Margin Bawah 20 */}
              <div className="w-[1290px] h-[64px] px-8 text-slate-900 liquid-glass-3d rounded-[18px] flex flex-col justify-center mb-[20px] shrink-0">
              ...
              <div className="flex flex-wrap gap-x-[30px] gap-y-[20px] w-full">
                {[
                  ...
                  /* Card Item - Ukuran: 300x229, Rounded 28 */
                  <div
                    key={idx}
                    className="w-[300px] h-[229px] p-6 transition-all duration-300 flex flex-col justify-start liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0"
                  >
                    ...
                    {/* Judul: 1 Baris */}
                    <h3 className="text-[15px] font-bold text-slate-900 leading-snug whitespace-nowrap overflow-hidden text-ellipsis mb-2">
                      {item.title}
                    </h3>
            ...
            <section id="work" className="w-[1290px] flex flex-col shrink-0 mb-[20px]">
              ...
              <div className="flex flex-wrap gap-x-[30px] gap-y-[20px] w-full">
                {[
                  ...
                  },
                  {
                   ...
                   /* Card Item Project - Ukuran: 300x229, Rounded 28 */
                  <div
                    key={idx}
                    className="w-[300px] h-[229px] p-6 transition-all duration-300 flex flex-col justify-between liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0"
                  >
                    <div>
                      <div className="w-10 h-10 mb-3 rounded-full text-slate-800 bg-white/80 border border-white flex items-center justify-center shrink-0 shadow-sm">
                        <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <h3 className="text-[15px] font-extrabold text-slate-900 leading-snug whitespace-nowrap overflow-hidden text-ellipsis mb-2">
                        {proj.name}
                      </h3>
                      <p className="text-[12.5px] font-normal text-slate-600 leading-relaxed text-justify line-clamp-3">
                        {proj.desc}
                      </p>
                    </div>
                    ...
                    <button
                      type="button"
                      onClick={proj.action}
                      className="w-full inline-flex items-center justify-center h-[36px] rounded-[14px] text-[12px] font-bold text-white bg-slate-900 hover:bg-slate-800 transition-all cursor-pointer shadow-sm mt-2"
                    >
            ...
            <section id="tools" className="w-[1290px] flex flex-col shrink-0 mb-[20px]">
              ...
              {/* Grid Layout Tools - Gap 20px H, 20px V */}
              <div className="flex flex-wrap gap-x-[20px] gap-y-[20px] w-full">
                {[
                  {
                  ...
                  /* Card Item Tools - Ukuran: 414x141, Rounded 28 */
                  <div
                    key={idx}
                    className="w-[414px] h-[141px] p-6 transition-all duration-300 flex flex-col justify-start liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0"
                  >
            ...
            <footer
              id="contact"
              className="px-10 h-[100px] w-[1290px] text-slate-900 liquid-glass-3d rounded-full overflow-hidden flex flex-row items-center justify-between shrink-0"
            >
              ...
              <div className="flex gap-4 shrink-0">
                <a
                  href="mailto:andhikarievaldy@gmail.com"
                  className="text-white font-bold text-[13px] px-8 py-3 rounded-full shadow-md bg-slate-900 hover:bg-slate-800 transition-all"
                >
                  Send Email Direct
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-900 font-bold text-[13px] px-8 py-3 rounded-full bg-white/80 border border-white hover:bg-white transition-all shadow-sm"
                >
                  LinkedIn Profile
                </a>
              </div>
        ...
        {/* ========================================================= */}
        {/* VIEW LAINNYA (TETAP MENJAGA 1440PX KANVAS JIKA AKTIF)     */}
        {/* ========================================================= */}
          ...
          <div className="w-[1290px] flex flex-col gap-[20px] shrink-0">
            ...
            <div className="flex flex-row flex-wrap gap-x-[30px] gap-y-[20px] w-[1290px]">
              {[
                ...
                <div
                  key={idx}
                  className="w-[630px] min-h-[229px] p-8 transition-all duration-300 flex flex-col justify-between liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0"
                >
          ...
          <div className="w-[1290px] flex flex-col gap-[20px] shrink-0">
            ...
            <div className="flex flex-row flex-wrap gap-[30px] w-full">
              {[
                ...
                <div
                  key={idx}
                  className="w-[410px] min-h-[229px] p-8 transition-all duration-300 flex flex-col justify-between liquid-glass-3d rounded-[28px] hover:scale-[1.015] overflow-hidden shrink-0"
                >
                  <div className="space-y-2 mb-4">
                    <h2 className="text-[18px] font-extrabold text-slate-900 leading-tight line-clamp-2">{item.name}</h2>
